...
const char* ssid = "Gearbox Staff";                //replace with our wifi ssid
const char* password = "Staff@Gearbox";         //replace with your wifi password

const char* host = "script.google.com";
const char *GScriptId = "AKfycbwEKUZTXBC1n5xvETHb1LRGE3V8WkXpQ2bZE4ACGz-FHLdP1ClEaF42NSkNuBw6VNWchg"; // Replace with your own google script id
